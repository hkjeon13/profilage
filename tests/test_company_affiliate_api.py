...
def test_profile_page_serves_company_profile_frontend():
    ...
    assert "/styles.css?v=company-profile-51" in response.text
    ...
    assert "/profile-page-5.js?v=company-profile-49" in response.text
...
def test_profile_frontend_can_add_company_to_compare_list():
    ...
    assert "/profile-page-5.js?v=company-profile-49" in profile_response.text
...
def test_financial_summary_cards_open_trend_modal_with_account_checks():
    ...
    assert ".financial-trend-close {\n  display: inline-grid;" in style_response.text
...
def test_relationship_summary_cards_open_company_list_modal():
    ...
    assert "/styles.css?v=company-profile-51" in profile_response.text
    assert "/profile-page-5.js?v=company-profile-49" in profile_response.text
