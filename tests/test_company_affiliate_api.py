...
def test_profile_page_serves_company_profile_frontend():
    ...
    assert "/styles.css?v=company-profile-55" in response.text
    ...
    assert "/profile-page-5.js?v=company-profile-52" in response.text
...
def test_relationship_summary_cards_open_company_list_modal():
    ...
    assert "/styles.css?v=company-profile-55" in profile_response.text
    assert "/profile-page-5.js?v=company-profile-52" in profile_response.text
